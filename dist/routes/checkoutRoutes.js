...
router.get("/summary/:customerId/:customerId", checkoutController_1.getCheckoutSummary);
router.post("/:customerId/:sessionId", checkoutController_1.createCheckoutSession);
